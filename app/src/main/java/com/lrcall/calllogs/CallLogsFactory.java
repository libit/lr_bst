...
public abstract class CallLogsFactory
{
	 ...
	 * @return
	 */
	public abstract List<CallLogInfo> getCallLogsByNumber(Context context, String number);
	 ...
	 */
	public abstract boolean addCallLogInfo(Context context, CallLogInfo callLogInfo);
	 ...
	 * @param context
	 */
	public abstract int deleteAllCallLogs(Context context);
	 ...
	 * @param selectionArgs
	 */
	public abstract int deleteCallLog(Context context, String where, String[] selectionArgs);
	 ...
	 * @param contactId 联系人ID
	 */
	public abstract int deleteContactCallLogs(Context context, Long contactId);
	 ...
	 * @param number  号码
	 */
	public abstract int deleteNumberCallLogs(Context context, String number);
