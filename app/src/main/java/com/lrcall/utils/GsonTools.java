...
import com.lrcall.appbst.models.ReturnListInfo;
...
public class GsonTools
{
	...
	public static ReturnInfo getReturnInfo(String json)
	{
		...
		try
		{
			return getBuildGson().fromJson(json, ReturnInfo.class);
		}
		catch (Exception e)
		{
			return null;
	...
	public static ReturnListInfo getReturnListInfo(String json)
	{
		...
		try
		{
			return getBuildGson().fromJson(json, ReturnListInfo.class);
		}
		catch (Exception e)
		{
			return null;
	...
	public static <T> T getObject(String json, Class<T> classOfT)
	{
		...
		try
		{
			return getBuildGson().fromJson(json, classOfT);
		}
		catch (Exception e)
		{
			return null;
