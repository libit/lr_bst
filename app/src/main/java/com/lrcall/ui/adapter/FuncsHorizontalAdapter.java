 ...
 */
public class FuncsHorizontalAdapter extends BaseFuncsAdapter
{
	public FuncsHorizontalAdapter(Context context, List<FuncInfo> list, IFuncsAdapterItemClicked funcsAdapterItemClicked)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (viewHolder == null)
		{
			convertView = LayoutInflater.from(context).inflate(R.layout.item_func_horizontal, null);
