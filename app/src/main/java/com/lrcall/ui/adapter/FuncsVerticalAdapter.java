 ...
 */
public class FuncsVerticalAdapter extends BaseFuncsAdapter
{
	public FuncsVerticalAdapter(Context context, List<FuncInfo> list, IFuncsAdapterItemClicked funcsAdapterItemClicked)
	{
