 ...
 */
public class IndexRecommendProductsAdapter extends BaseUserAdapter<ProductInfo>
{
	protected final IRecommendProductsAdapter iRecommendProductsAdapter;

	public IndexRecommendProductsAdapter(Context context, List<ProductInfo> list, IRecommendProductsAdapter iRecommendProductsAdapter)
	{
		super(context, list);
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (viewHolder == null)
		{
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.item_recommend_product, null);
		...
		convertView.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				{
					iRecommendProductsAdapter.onProductClicked(productInfo);
				}
			}
		});
		return convertView;
