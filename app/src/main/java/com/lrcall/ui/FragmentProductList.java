...
public class FragmentProductList extends MyBasePageFragment implements IAjaxDataResponse, View.OnClickListener
{
	...
	public static FragmentProductList newInstance(String sortId)
	{
	...
	public void loadMoreData()
	{
		...
		mProductService.getProductListBySortId(sortId, mDataStart, getPageSize(), tips, false);
	}
		...
		if (mProductAdapter == null)
		{
			mProductAdapter = new ProductAdapter(getContext(), mProductInfoList, new ProductAdapter.IItemClick()
			{
				...
				public void onProductClicked(ProductInfo productInfo)
				{
					if (productInfo != null)
					{
						Intent intent = new Intent(FragmentProductList.this.getContext(), ActivityProduct.class);
