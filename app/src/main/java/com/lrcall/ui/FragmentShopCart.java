...
public class FragmentShopCart extends MyBaseFragment implements View.OnClickListener
{
	private static final String TAG = FragmentShopCart.class.getSimpleName();
