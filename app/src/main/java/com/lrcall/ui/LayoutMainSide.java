 ...
 */
public class LayoutMainSide extends LinearLayout implements View.OnClickListener, IAjaxDataResponse
{
	...
	public LayoutMainSide(Activity context)
	{
		super(context);
	...
	public LayoutMainSide(Activity context, AttributeSet attrs)
	{
		super(context, attrs);
		this.mActivity = context;
		this.mContext = context;
	...
	private void viewInit()
	{
		...
		rootView = LayoutInflater.from(mContext).inflate(R.layout.layout_main_slide, null);
