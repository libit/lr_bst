...
public class ActivityWebView extends MyBaseActivity implements XListView.IXListViewListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (bundle != null)
		{
			...
			setTitle(webTitle);
			mUrl = bundle.getString(ConstValues.DATA_WEB_URL);
		}
		viewInit();
		loadUrl();
	}
	...
	private void loadUrl()
	{
		...
		{
			LogcatTools.info("openUrl", "mUrl:" + mUrl);
	...
	protected void viewInit()
	{
		...
		webView.setWebChromeClient(new WebChromeClient()
		{
			...
			public boolean onJsConfirm(WebView view, String url, String message, JsResult result)
			{
				...
				// new LibitDialog(ActivityWebView.this, new LibitDialogProgressListener()
				// {
				// @Override
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		if (id == R.id.action_refresh)
		{
			...
			if (StringTools.isNull(url) || !url.startsWith("http"))
			{
				loadUrl();
			}
			else
	...
	private void openUrl(String url)
	{
		try
		{
			LogcatTools.info("openUrl", "url:" + url);
