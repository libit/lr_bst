...
import com.lrcall.appbst.models.DbObject;
...
public class DataBaseProvider extends ContentProvider
{
	...
	{
		int index = 1;
		tableInfos = new TableInfo[]{new TableInfo(DbConstant.TABLE_NAME_LOCAL_INFO, index++, index++), new TableInfo(DbConstant.TABLE_NAME_NUMBER_LABEL, index++, index++), new TableInfo(DbConstant.TABLE_NAME_BLACK_NUMBER, index++, index++), new TableInfo(DbConstant.TABLE_NAME_WHITE_NUMBER, index++, index++), new TableInfo(DbConstant.TABLE_NAME_PRODUCT_SORT, index++, index++), new TableInfo(DbConstant.TABLE_NAME_NEWS, index++, index++), new TableInfo(DbConstant.TABLE_NAME_PRODUCT, index++, index++), new TableInfo(DbConstant.TABLE_NAME_BANNER, index++, index++), new TableInfo(DbConstant.TABLE_NAME_STAR, index++, index++), new TableInfo(DbConstant.TABLE_NAME_ADDRESS, index++, index++), new TableInfo(DbConstant.TABLE_NAME_SHOP_CART, index++, index++), new TableInfo(DbConstant.TABLE_NAME_DATA_TRAFFIC, index++, index++)};
	...
	public String getType(@NonNull Uri uri)
	{
		...
		LogcatTools.error(TAG, "getType:" + UNKNOWN_URI_LOG + uri);
	...
	public Uri insert(@NonNull Uri uri, ContentValues values)
	{
		...
		{
			LogcatTools.error(TAG, "insert:matchedTable为空！");
			throw new IllegalArgumentException(UNKNOWN_URI_LOG + uri);
		}
		if (values == null)
		{
		...
		LogcatTools.error(TAG, "insert:插入数据到" + uri + "失败！");
	...
	public int delete(@NonNull Uri uri, String selection, String[] selectionArgs)
	{
		...
		if (!isMatch)
		{
			LogcatTools.error(TAG, "delete:未找到匹配的URI" + uri + "！");
			throw new IllegalArgumentException(UNKNOWN_URI_LOG + uri);
		}
		return count;
	}
	...
	public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
	{
		...
		if (!isMatch)
		{
			LogcatTools.error(TAG, "query:未找到匹配的URI" + uri + "！");
			throw new IllegalArgumentException(UNKNOWN_URI_LOG + uri);
		}
		SQLiteDatabase db = mOpenHelper.getReadableDatabase();
		return qb.query(db, projection, selection, finalSelectionArgs, finalGrouping, finalHaving, finalSortOrder);
	}
	...
	public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs)
	{
		...
		if (!isMatch)
		{
			LogcatTools.error(TAG, "update:未找到匹配的URI" + uri + "！");
			throw new IllegalArgumentException(UNKNOWN_URI_LOG + uri);
		}
		return count;
	}
	...
	public static class TableInfo
	{
		...
		public TableInfo(String tableName, int table, int table_id)
		{
			this.tableName = tableName;
			this.table = table;
			this.table_id = table_id;
			this.field_id = DbObject.FIELD_ID;
		}
