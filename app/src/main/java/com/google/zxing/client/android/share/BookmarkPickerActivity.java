...
public final class BookmarkPickerActivity extends ListActivity
{
	...
	private static final String[] BOOKMARK_PROJECTION = {"title", // Browser.BookmarkColumns.TITLE
	...
	{
		super.onResume();
		cursor = getContentResolver().query(BOOKMARKS_URI, BOOKMARK_PROJECTION, BOOKMARK_SELECTION, null, null);
		if (cursor == null)
		{
