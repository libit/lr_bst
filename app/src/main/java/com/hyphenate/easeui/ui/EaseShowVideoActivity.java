...
public class EaseShowVideoActivity extends EaseBaseActivity
{
	...
	public String getLocalFilePath(String remoteUrl)
	{
		...
		{
			localPath = PathUtil.getInstance().getVideoPath().getAbsolutePath() + "/" + remoteUrl.substring(remoteUrl.lastIndexOf("/") + 1) + ".mp4";
		}
		else
		{
			localPath = PathUtil.getInstance().getVideoPath().getAbsolutePath() + "/" + remoteUrl + ".mp4";
		}
		return localPath;
	}
